...
public class ViewLogs extends ActionBarActivity {
    ...
    private RadioButton r_announcements;
    private RadioButton r_censor;
    private RadioButton r_pin_change;
    private RadioButton r_reset;
    private RadioButton r_user_registration;
    private RadioButton r_edit_user;
    private RadioButton r_notices;
    private RadioButton r_activations;
    private RadioButton r_deactivations;
    private RadioButton r_censor_mode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatePicker d_start_date = (DatePicker)findViewById(R.id.startDatePicker);
        final DatePicker d_end_date = (DatePicker)findViewById(R.id.endDatePicker);
        final EditText e_id_number = (EditText)findViewById(R.id.idNumberEditText);
        ...
        r_announcements = (RadioButton)findViewById(R.id.announcementsRadioButton);
        r_censor = (RadioButton)findViewById(R.id.censorApprovalRadioButton);
        r_pin_change = (RadioButton)findViewById(R.id.pinChangeRadioButton);
        r_reset = (RadioButton)findViewById(R.id.ResetRadioButton);
        r_user_registration = (RadioButton)findViewById(R.id.userRegistrationRadioButton);
        r_edit_user = (RadioButton)findViewById(R.id.editUserRadioButton);
        r_notices = (RadioButton)findViewById(R.id.systemNoticesRadioButton);
        r_activations = (RadioButton)findViewById(R.id.userActivationsRadioButton);
        r_deactivations = (RadioButton)findViewById(R.id.UserDeactivationsRadioButton);
        r_censor_mode = (RadioButton)findViewById(R.id.CensorModeRadioButton);
